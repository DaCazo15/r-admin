    ...
    >
      ...
      >
        ...
        <button
          type="button"
          @click="enviar"
          class="cursor-pointer px-1 py-1.5 sm:px-4 sm:py-2 text-sm sm:text-base text-white font-bold rounded-lg transition-colors flex items-center gap-1.5 sm:gap-2"
          style="background-color: #25d366"
        >
