export const plantillasMensaje = {
  ...
  cobro: (saludo, monto) => 
    `${saludo}\n\nTe contactamos desde *Tesorería* de Rotaract Isla de Margarita. Tienes un monto pendiente de *$${Number(monto || 0).toFixed(2)}* correspondiente a la mensualidad del club.\n\nPor favor realiza el pago a la brevedad y envíanos el comprobante. ¡Gracias por tu apoyo! 🙏`,
